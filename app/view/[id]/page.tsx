        ...
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          {doc && (
            <span style={{ color: "#8e9ab0", fontSize: "13px", fontFamily: "system-ui, sans-serif" }}>
              {doc.file_name}
              {doc.file_size && (
                <span style={{ marginLeft: "8px", fontSize: "11px" }}>· {formatSize(doc.file_size)}</span>
              )}
            </span>
          )}
        </div>
        ...
        {loading && (
          <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <div style={{ textAlign: "center" }}>
              ...
              <p style={{ marginTop: "12px", color: "#8e9ab0", fontSize: "13px", fontFamily: "system-ui, sans-serif" }}>
                Loading document…
              </p>
            </div>
          </div>
